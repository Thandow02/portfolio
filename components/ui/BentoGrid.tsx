...
/* ─── tiny CSS confetti — no external libs ─── */
const CONFETTI_COLORS = [
  "#a855f7", "#3b82f6", "#ec4899", "#f59e0b", "#10b981", "#f43f5e",
];
...
export const BentoGridItem = ({
  ...
  const leftLists = ["SQL", "Python", "Power BI"];
  const rightLists = ["Oracle Cloud", "JIRA", "Excel"];

  const [copied, setCopied] = useState(false);

  const handleCopy = () => {
    navigator.clipboard.writeText("amumathebula22@gmail.com");
    setCopied(true);
